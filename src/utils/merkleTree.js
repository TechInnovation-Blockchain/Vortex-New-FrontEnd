...
export default class MerkleTree {
  ...
  constructor(elements) {
    ...
    this.#bufferElementPositionIndex = this.#elements.reduce(
      (memo, el, index) => {
        memo[bufferToHex(el)] = index // eslint-disable-line no-param-reassign
        return memo
      },
      {},
    )
  ...
  getNextLayer = (elements) => elements.reduce((layer, el, idx, arr) => { // eslint-disable-line class-methods-use-this
    if (idx % 2 === 0) {
